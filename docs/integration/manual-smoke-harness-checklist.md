...
| -------------------------- | -------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| docker bootstrap + seed    | `pnpm smoke` stays preflight-only, then the Docker wrapper seeds the canonical `home` entry. | `tests/contracts/docker-local-host-smoke-docs.test.ts`, `tests/contracts/docker-local-host-bootstrap-assets.test.ts`, `tests/contracts/docker-local-host-seed.test.ts` |
